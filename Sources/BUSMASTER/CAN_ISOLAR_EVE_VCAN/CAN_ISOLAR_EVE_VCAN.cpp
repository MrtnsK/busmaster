...
HRESULT	CDIL_ISOLAR_EVE_VCAN::myCanClose(HANDLE handle)
{
	return S_OK;
}


HRESULT	CDIL_ISOLAR_EVE_VCAN::GetHWinfo(HANDLE handle, unsigned long *pulSNHigh, unsigned long *pulSNLow, int *res)
{
	(*res) = 0;
	return S_OK;
}
