 ...
 */
// CAN_AGCO.cpp : Defines the initialization routines for the DLL.
//
...
#define USAGE_EXPORT
#include "CAN_AGCO_Extern.h"

BEGIN_MESSAGE_MAP(CCAN_AGCO, CWinApp)
END_MESSAGE_MAP()


/**
 * CCAN_AGCO construction
 */
CCAN_AGCO::CCAN_AGCO()
{
...
// The one and only CCAN_AGCO object
CCAN_AGCO theApp;


/**
 * CCAN_AGCO initialization
 */

static HINSTANCE ghLangInst=nullptr;

BOOL CCAN_AGCO::InitInstance()
{
...
DWORD WINAPI CanMsgReadThreadProc_CAN_AGCO(LPVOID pVoid)
{
    ...
    /* Set the event to CAN_AGCO driver for wakeup and frame arrival notification */
    for (UINT i = 0; i < sg_unClientCnt; i++)
    {
